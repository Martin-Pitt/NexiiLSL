/*
    These are a series of functions related to converting between HUD and region coordinates
    A lot of these are inspired by code from Babbage Linden: https://wiki.secondlife.com/wiki/SLateIt
    
    Now we have llWorldPosToHUD which eases one side of this equation (however it strips out distance on the x component)
*/
